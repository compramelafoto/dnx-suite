...
export default async function ContestJuradoPage({ params }: PageProps) {
  ...
  return (
    ...
    >
      <PageInfoRecuadro variant="placeholder">
        <p className="fr-body text-fr-muted">Próximamente. Definir integrantes y criterios de evaluación.</p>
