...
import { UpcomingContestsSection } from "../contest-upcoming/UpcomingContestsSection";
import {
  EmptyState,
  PageContainer,
  PrimaryButton,
...
export function HomeView({ contests, header }: Props) {
  return (
    ...
    >
      ...
      {/**
       * Concursos próximos ("El País que Miramos"). No renderiza nada si no hay
       * ninguno en UPCOMING, así que un borrador nunca llega a la home.
       */}
