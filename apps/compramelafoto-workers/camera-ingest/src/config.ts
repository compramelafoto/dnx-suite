...
const envSchema = z.object({
  ...
  CAMERA_INGEST_POLL_INTERVAL_MS: z.coerce.number().int().positive().default(3000),
  CAMERA_INGEST_MAX_ATTEMPTS: z.coerce.number().int().positive().default(3),
  CAMERA_INGEST_STALE_MINUTES: z.coerce.number().int().positive().default(30),
  CAMERA_INGEST_BATCH_CONCURRENCY: z.coerce.number().int().positive().default(1),
});
