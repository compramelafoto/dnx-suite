...
export const formarParteContent = {
  ...
  touchpoints: {
    eyebrow: "Alcance",
    title: "Tu marca acompaña al participante durante toda la experiencia.",
    lead: "Desde el primer anuncio hasta la premiación, tu marca puede estar presente en cada momento del recorrido.",
    stages: [
      {
        id: "antes",
        number: "01",
        title: "Antes del evento",
        description: "Tu marca aparece en la difusión que construye expectativa y convocatoria.",
      ...
      },
      {
        ...
        number: "02",
        title: "Inscripción",
        description: "Del primer clic al kit: presencia en cada paso de la llegada.",
      ...
      },
      {
        ...
        description: "La jornada completa: merchandising, espacios y momentos compartidos.",
        icon: "camera" as const,
        badges: [
          "Remera",
          "Lanyard",
      ...
      },
      {
        ...
        description: "La experiencia sigue viva en resultados, contenido y nuevas ediciones.",
    ...
    highlight: {
      line1: "Una sola forma de sumarte.",
      line2: "Decenas de oportunidades para conectar con miles de personas.",
    },
  },
  ...
  allies: {
    ...
    logos: [
      ...
      {
        name: "COPY express",
        src: "/images/formar-parte/allies/copy-express.svg",
        scale: "lg" as const,
      },
      {
        name: "DVV",
        src: "/images/formar-parte/allies/dvv.svg",
        scale: "lg" as const,
      },
      {
        name: "Mucha Escuela",
        src: "/images/formar-parte/allies/mucha-escuela.svg",
        scale: "lg" as const,
      },
    ],
  },
  ...
  levels: {
    ...
    lead: "Cada nivel ofrece distinta participación y visibilidad dentro de la experiencia Clickatón.",
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          "Puede conversarse según el rubro y la edición. No hay un esquema cerrado: cada participación se diseña con criterio y coherencia.",
      },
      {
  ...
  final: {
    ...
    line2: "Las mejores marcas también.",
    cta: {
