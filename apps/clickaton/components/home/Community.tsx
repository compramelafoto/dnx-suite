  ...
  return (
    <Section id={community.id} tone="raised" aria-labelledby="community-title">
      <Container className="mx-auto max-w-3xl text-center">
        ...
        />
        <ul className="mt-[var(--ck-stack-subtitle-to-content)] flex flex-wrap justify-center gap-2">
        ...
        <div className="mt-[var(--ck-stack-content-to-actions)] flex flex-col items-center gap-2">
