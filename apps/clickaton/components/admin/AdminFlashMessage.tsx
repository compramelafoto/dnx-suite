...
const FLASH_MESSAGES: Record<string, { title: string; body?: string; tone: "success" | "warning" | "danger" }> = {
  ...
  variant_created: { title: "Talle u opción creado", tone: "success" },
  variant_updated: { title: "Talle u opción actualizado", tone: "success" },
  variant_activated: { title: "Talle u opción reactivado", tone: "success" },
  variant_deactivated: { title: "Talle u opción desactivado", tone: "success" },
  changes_saved: { title: "Cambios guardados", tone: "success" },
  email_resent: { title: "Correo reenviado", tone: "success" },
  welcome_card_generated: { title: "Placa generada", tone: "success" },
