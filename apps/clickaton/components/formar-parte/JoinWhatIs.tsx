...
const { whatIs } = formarParteContent;

export function JoinWhatIs() {
  return (
    <Section
      tone="base"
      className="py-20 sm:py-28 lg:py-36"
      aria-labelledby="join-what-title"
    >
      <Container>
          ...
          <div className="max-w-xl">
            ...
            <div className="mt-10 space-y-6">
              {whatIs.paragraphs.map((paragraph) => (
                <p key={paragraph.slice(0, 40)} className="ck-body-lg text-ck-text-secondary">
                  {paragraph}
                </p>
              ))}
            </div>
