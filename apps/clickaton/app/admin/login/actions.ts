...
/**
 * Login email/contraseña DNX Identity → misma sesión `dnx_session` y mismo guard admin.
 * Autenticación ≠ autorización: sin allowlist / SUPER_ADMIN no entra al panel.
 */
export async function loginAdminAction(
  ...
  if (!user.password) {
    return {
      error:
        "Esta cuenta no tiene contraseña configurada. Usá Continuar con Google o contactá a DNX Identity.",
    };
  }
