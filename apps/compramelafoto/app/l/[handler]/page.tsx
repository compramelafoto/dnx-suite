    ...
    try {
      ...
      if (labUser) {
        labAlbums = await prisma.album.findMany({
          ...
          include: {
            photos: {
              ...
              select: { id: true, previewUrl: true, originalKey: true, isRemoved: true },
        ...
        labAlbums = labAlbums.filter((album) => isAlbumPubliclyAccessible(album)).map((album) => ({
          ...album,
          photosCount: countActiveAlbumPhotos(album.photos),
          ...buildAlbumListCoverUrls({
            id: album.id,
                    ...
                    <Card className="overflow-hidden hover:shadow-lg transition-shadow cursor-pointer">
                      {album.coverPhotoUrl && album.photosCount > 0 ? (
                        ...
                        <div className="aspect-square flex flex-col items-center justify-center p-4 bg-[#f3f4f6]">
                          <Image src="/watermark.png" alt="ComprameLaFoto" width={80} height={80} className="opacity-50" unoptimized />
