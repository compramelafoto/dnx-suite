...
import LabResumenPage from "@/components/lab/LabResumenPage";

export const dynamic = "force-dynamic";
export const runtime = "nodejs";

export default async function LabResumenHandlerPage({
  params,
}: {
  ...
  return <LabResumenPage lab={lab} handler={handler} />;
}
