...
export default function DirectorioServiciosDeEventosPage() {
        ...
        <div className="container-custom">
          <div className="max-w-5xl mx-auto text-center mb-12">
            ...
            <p className="text-lg text-[#6b7280] mb-6">
              Proveedores para tus eventos: catering, sonido, decoración, animación y más. Misma estructura y calidad que el resto del directorio.
            </p>
          ...
          <div id="directorio-servicios-de-eventos">
