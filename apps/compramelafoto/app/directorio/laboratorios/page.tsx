        ...
        <div className="container-custom">
          ...
          {loading ? (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {sorted.map((lab) => (
                <Card key={lab.id} className="overflow-hidden h-full flex flex-col">
                        {lab.logoUrl && (
                        ...
                        <div className="flex-1">
                          ...
                          {(lab.city || lab.province) && (
                            <p className="text-sm text-[#6b7280] mb-2 flex items-center gap-1">
                              <span>📍</span> {[lab.city, lab.province].filter(Boolean).join(", ")}
                            </p>
                          )}
                          {lab.phone && (
                            <p className="text-sm text-[#6b7280] mb-2 flex items-center gap-1">
                          ...
                          <div className="flex flex-wrap gap-2 mt-3">
                            {lab.instagram && (
                              <a
                                href={lab.instagram.startsWith("http") ? lab.instagram : `https://instagram.com/${lab.instagram.replace(/^@/, "")}`}
                                target="_blank"
                            ...
                            {lab.facebook && (
                              <a
                                href={lab.facebook.startsWith("http") ? lab.facebook : `https://facebook.com/${lab.facebook}`}
                                target="_blank"
                                rel="noopener noreferrer"
                                className="inline-flex items-center justify-center w-9 h-9 rounded-full bg-[#f7f5f2] hover:bg-[#c27b3d]/15 text-[#6b7280] hover:text-[#c27b3d] transition-colors"
                                aria-label="Facebook"
