                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-sm text-[#6b7280] mt-1">
                          ...
                          {ev.source === "ALBUM" && ev.photographerName
                            ? ` • ${ev.photographerName}`
                            : ""}
                        </p>
                        {ev.startsAt && (() => {
        ...
        <div className="container-custom">
          <div className="max-w-6xl mx-auto text-center space-y-6">
            ...
            <div className="mt-10 text-center">
              <p className="text-sm text-[#6b7280] mb-2">
                Fotógrafos, laboratorios, organizadores, servicios para fotógrafos y proveedores de eventos
              </p>
              <Link
      ...
      <section className="section-spacing bg-[#f9fafb]">
        <div className="container-custom">
          <div className="max-w-5xl mx-auto text-center mb-12">
            ...
            <p className="text-lg text-[#6b7280]">
              Fotógrafos, laboratorios, organizadores y proveedores que trabajan con nosotros. Conocelos y explorá cada
              directorio.
            </p>
          </div>
          <div className="max-w-5xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            >
              ...
              {directoryCounts !== null && (
                <span className="text-sm text-[#6b7280] mt-1">
                  {directoryCounts.organizers} {directoryCounts.organizers === 1 ? "perfil" : "perfiles"}
                </span>
              )}
            </Link>
          </div>
