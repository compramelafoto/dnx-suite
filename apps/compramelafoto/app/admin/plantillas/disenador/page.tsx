    ...
    <div className="h-screen flex flex-col overflow-hidden w-full max-w-full min-w-0 bg-[#f1f5f9]">
      ...
      <header className="shrink-0 flex flex-wrap items-center gap-3 px-4 py-3 bg-white border-b border-[#e2e8f0]">
        ...
        <div className="flex-1 flex flex-wrap items-center gap-x-4 gap-y-1">
          <span className="font-semibold text-[#1a1a1a]">Diseñador clásico (V1)</span>
          <Link href="/dashboard/designs" className="text-xs font-semibold text-[#c27b3d] hover:underline whitespace-nowrap">
            Ir al editor nuevo (V2) →
          </Link>
