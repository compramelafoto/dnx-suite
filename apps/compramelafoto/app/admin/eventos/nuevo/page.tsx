  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      <div className="flex-1 w-full max-w-4xl mx-auto px-4 sm:px-6 py-8 box-border">
        <Link href="/admin/eventos" className="text-sm text-gray-600 hover:text-gray-900 mb-4 inline-block">
          ← Volver a eventos
        </Link>
        <h1 className="text-2xl font-bold text-gray-900 mb-6">Crear evento (admin)</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-4 w-full min-w-0">
            ...
            <div className="w-full min-w-0">
              ...
              <p className="text-xs text-gray-500 mt-1">
                En eventos privados solo los fotógrafos invitados podrán inscribirse.
              </p>
            </div>
            <div className="w-full min-w-0">
