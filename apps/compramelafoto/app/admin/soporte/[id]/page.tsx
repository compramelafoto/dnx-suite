  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="p-6 space-y-3">
        ...
        <div className="text-sm text-[#1a1a1a] whitespace-pre-wrap break-words border-t border-[#e5e7eb] pt-4">
          {ticket.description}
        </div>
      </Card>
          ...
          <div className="space-y-4">
            {ticket.messages.map((msg: any) => (
              <div key={msg.id} className="rounded-lg border border-[#e5e7eb] p-4">
                ...
                <div className="text-sm text-[#1a1a1a] whitespace-pre-wrap break-words">{msg.message}</div>
              </div>
            ))}
          </div>
        ) : (
