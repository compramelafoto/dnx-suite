...
export default function EventNotifyForm({ shareSlug }: { shareSlug: string }) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setLoading(true);
    try {
      const res = await fetch(`/api/public/events/${shareSlug}/interest`, {
        method: "POST",
      ...
      setMessage(data?.message || "¡Listo! Te avisaremos cuando la galería esté disponible.");
