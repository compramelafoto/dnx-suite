...
export async function POST(
  ...
  try {
    ...
    const albumTestRow = await prisma.album.findUnique({
      where: { id: albumId },
    ...
    const testDenyShot = await denyIfTestAlbumNotOwnerPreview(albumTestRow, user);
    if (testDenyShot) return testDenyShot;
