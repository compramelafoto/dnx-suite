...
function friendlyMessage(reason: string): string {
  ...
  if (reason === "invalid_status") {
    return "Solo podés marcar como entregado cuando el ítem está en la escuela.";
  }
  return "No se pudo marcar el ítem como entregado.";
}

/**
 * POST: pasar un ítem escolar de AT_SCHOOL a DELIVERED (fotógrafo).
 */
