...
export async function PATCH(
  ...
  try {
    ...
    if (allowUnpaidOrderClientData !== undefined) {
      if (typeof allowUnpaidOrderClientData !== "boolean") {
        return NextResponse.json(
          { error: "allowUnpaidOrderClientData debe ser true o false" },
          { status: 400 }
        );
      }
      updateData.allowUnpaidOrderClientData = allowUnpaidOrderClientData;
    }
      ...
      role !== undefined
        ...
        : isBlocked !== undefined
          ? isBlocked
            ? "BLOCK_USER"
            : "UNBLOCK_USER"
          : allowUnpaidOrderClientData !== undefined
            ? "UPDATE_USER_CLIENT_VISIBILITY"
            : "UPDATE_USER_FEE";
    const description =
      role !== undefined
        ...
        : isBlocked
          ...
          : isBlocked !== undefined
            ...
            : allowUnpaidOrderClientData !== undefined
              ? `Ver datos de cliente antes de pago: ${allowUnpaidOrderClientData ? "activado" : "desactivado"}`
    ...
    await logAdminAction({
      ...
      beforeData: {
        ...
        allowUnpaidOrderClientData: currentUser.allowUnpaidOrderClientData,
      },
      afterData: {
        ...
        allowUnpaidOrderClientData: updatedUser.allowUnpaidOrderClientData,
      },
      ipAddress,
      userAgent,
    });
