...
import { approveDesignProject } from "@/lib/school-design/review-actions";
...
export async function POST(
  ...
  try {
    ...
    const res = await approveDesignProject({ designProjectId: dp.id, userId: user.id });
    if (!res.ok) {
    ...
    console.error("[school_design_review] approve", e);
