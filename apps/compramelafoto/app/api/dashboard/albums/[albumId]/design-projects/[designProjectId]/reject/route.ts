...
import { rejectDesignProject } from "@/lib/school-design/review-actions";
...
export async function POST(
  ...
  try {
    ...
    const reviewReason = body.reviewReason != null ? String(body.reviewReason) : null;
    ...
    const res = await rejectDesignProject({
    ...
    console.error("[school_design_review] reject", e);
