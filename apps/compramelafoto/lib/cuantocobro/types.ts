...
export type CuantoCobroProfileInput = {
  ...
  equipmentInventory?: import("@/lib/cuantocobro/equipment/types").CuantoCobroEquipmentInventory;
...
export type { CuantoCobroCommercialDisplayMode } from "@/lib/cuantocobro/commercial-presentation";
import type { CuantoCobroCommercialDisplayMode } from "@/lib/cuantocobro/commercial-presentation";
import { CC_DEFAULT_COMMERCIAL_NOTE } from "@/lib/cuantocobro/commercial-presentation";
import type { CuantoCobroPaymentOptionsInput } from "@/lib/cuantocobro/payment/payment-options-types";
import { INITIAL_CUANTO_COBRO_PAYMENT_OPTIONS } from "@/lib/cuantocobro/payment/payment-options-types";
...
import type { CameraWearAnalysis, EquipmentDepreciationMode } from "@/lib/cuantocobro/camera-equipment";
import type { EquipmentSavingsBreakdown } from "@/lib/cuantocobro/equipment/types";
import type { CuantoCobroClientCostSummary } from "@/lib/cuantocobro/client-calculations";
import type { CuantoCobroQuoteSummary } from "@/lib/cuantocobro/quote-item-calculations";
import type { ChosenPriceCommercialStatus, ProfitabilityStatus } from "@/lib/cuantocobro/quote-profitability";
import { DEFAULT_PHOTOGRAPHY_TIME_DISTRIBUTION } from "@/lib/cuantocobro/availability";
import { createDefaultPersonalExpenseGroups } from "@/lib/cuantocobro/default-expense-groups";
