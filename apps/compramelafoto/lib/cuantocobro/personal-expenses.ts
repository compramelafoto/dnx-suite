...
import { normalizeCameraProfileFields } from "@/lib/cuantocobro/camera-equipment";
import { normalizeEquipmentProfileFields } from "@/lib/cuantocobro/equipment/normalize";
import { normalizeProfileAvailability } from "@/lib/cuantocobro/availability";
import {
  createDefaultPersonalExpenseGroups,
  createCustomExpenseItemId,
} from "@/lib/cuantocobro/default-expense-groups";
import {
