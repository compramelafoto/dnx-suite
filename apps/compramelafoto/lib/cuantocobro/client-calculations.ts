import { CLIENT_HOUR_FIELDS, CLIENT_HOUR_LABELS, CLIENT_HOUR_RATE_KEY } from "@/lib/cuantocobro/client-hours";
import { parseQuoteItemHours } from "@/lib/cuantocobro/quote-items";
import type { QuoteLaborRates } from "@/lib/cuantocobro/hourly-rates";
import type { CuantoCobroClientInput } from "@/lib/cuantocobro/types";
