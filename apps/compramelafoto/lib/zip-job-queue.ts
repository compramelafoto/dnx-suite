...
type JsonMeta = Exclude<Prisma.InputJsonValue, null>;
...
export async function countPendingZipJobs(): Promise<number> {
  return prisma.zipGenerationJob.count({
...
export async function setCurrentStep(jobId: string, step: string) {
