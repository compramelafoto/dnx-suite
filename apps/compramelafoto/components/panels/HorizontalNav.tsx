        ...
        {items.map((item) => {
            ...
            return (
              <li key={item.id} className="relative">
                <button
                  ...
                  className={`flex max-w-[14rem] min-w-0 items-center gap-1.5 px-4 py-3 text-left text-sm leading-snug whitespace-normal break-words transition-colors border-b-2 -mb-px ${
                    groupActive
                ...
                {isOpen && (
                  <>
                    ...
                    />
                    <ul
                      className="absolute left-0 top-full z-20 mt-0 py-1 min-w-[240px] max-w-[min(24rem,calc(100vw-2rem))] bg-white rounded-b-lg shadow-lg border border-gray-200"
                      role="menu"
                    >
                        ...
                        return (
                          <li key={sub.id} role="none">
                            <Link
                              ...
                              role="menuitem"
                              onClick={() => setOpenId(null)}
                              className={`block pl-5 pr-4 py-2.5 text-left text-sm leading-snug whitespace-normal break-words transition-colors ${subActive ? activeClass : inactiveClass}`}
                            >
                              {sub.label}
                            </Link>
                          </li>
          ...
          return (
            <li key={item.id}>
              <Link
                href={linkHref}
                className={`flex max-w-[14rem] min-w-0 items-center gap-1.5 px-4 py-3 text-sm leading-snug whitespace-normal break-words transition-colors border-b-2 -mb-px ${
