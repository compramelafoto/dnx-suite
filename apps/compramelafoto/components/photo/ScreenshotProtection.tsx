    ...
    <>
      {(isBlurred || isBlocked) && (
        <div className="fixed inset-0 z-[9999] pointer-events-none flex items-center justify-center">
          {/* pointer-events no se hereda: sin pointer-events-none en hijos, el capa fullscreen roba todos los clics (p. ej. tras cámara/archivo en reconocimiento facial). */}
          <div
          ...
          />
          <div className="pointer-events-none relative z-10 flex w-full max-w-2xl min-w-[min(100%,20rem)] flex-col items-center justify-center gap-4 px-4 sm:min-w-[28rem]">
