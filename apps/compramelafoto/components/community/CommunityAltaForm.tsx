...
type Props = {
  ...
  title: string;
  subtitle: string;
  /** Logo de ComprameLaFoto centrado arriba del formulario */
  brandLogoUrl?: string;
  /** Logo del partner/organizador (opcional, debajo del logo de marca) */
  partnerLogoUrl?: string;
  /** Nombre del partner si no hay logo */
  partnerName?: string;
};
...
export default function CommunityAltaForm({
  type,
  title,
  subtitle,
  brandLogoUrl,
    ...
    <div className="w-full max-w-4xl mx-auto">
      {brandLogoUrl ? (
        <div className="mb-8 flex justify-center">
          <Link href="/" className="inline-flex" aria-label="ComprameLaFoto — inicio">
            <Image
              src={brandLogoUrl}
              alt="ComprameLaFoto"
              width={200}
          ...
          {type === "EVENT_VENDOR" && (
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">
                Eventos en los que trabajaste / referencias
              </label>
              <Textarea
