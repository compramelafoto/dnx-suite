/**
 * Crea o actualiza el artículo «Día de la Bandera» (Casos de uso).
 * Ejecutar: npm run seed:blog:dia-de-la-bandera
 */
...
const SLUG = "dia-de-la-bandera-vender-fotos-escolares";
