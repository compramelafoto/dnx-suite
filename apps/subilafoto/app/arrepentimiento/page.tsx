...
export default function Arrepentimiento() {
  return (
    <main className="sobre-claro mx-auto max-w-xl px-6 py-14">
      <Link href="/" className="text-sm font-extrabold" style={{ color: "var(--slf-violeta)" }}>
        ← Subí la Foto
      </Link>
      ...
      <p className="mt-4 leading-relaxed" style={{ color: "var(--slf-tinta-suave)" }}>
        Si compraste y te arrepentiste, tenés <strong>{DIAS_PARA_ARREPENTIRSE} días
        corridos</strong> para cancelar sin costo y sin tener que explicar por qué. Es un
        derecho: el artículo 34 de la Ley 24.240 de Defensa del Consumidor.
      </p>

      <p className="mt-3 leading-relaxed" style={{ color: "var(--slf-tinta-suave)" }}>
        Completá esto y te damos un número de constancia en la misma pantalla. Después te
        escribimos al correo que dejes.
      </p>
