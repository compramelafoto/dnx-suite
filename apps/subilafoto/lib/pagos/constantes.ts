 ...
 *
 * Nunca la de otro producto: el retorno de una conexión de SubiLaFoto no puede
...
/**
 * SubiLaFoto conecta **cobradores**, no receptores de reparto.
 *
 ...
 * la suite: sin él, el vendedor de SubiLaFoto podría chocar con un workspace de
...
/** Inversa. Devuelve `null` si la referencia no es de SubiLaFoto. */
