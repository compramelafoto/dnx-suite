...
upload_file() {
  ...
  echo ""
  echo "=============================="
  echo "Subiendo production envs a: $project"
  echo "Archivo: $file"
  echo "=============================="
...
upload_file "compramelafoto-dnxsuite" "$ENV_DIR/compramelafoto-dnxsuite.production.env"
upload_file "fotorank-dnxsuite" "$ENV_DIR/fotorank-dnxsuite.production.env"
