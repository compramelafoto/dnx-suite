...
export const EMPTY_CONTENT_JSON: JSONContent = {
  type: "doc",
  content: [{ type: "paragraph" }],
};

/** Alias CLF. */
export const EMPTY_BLOG_CONTENT_JSON = EMPTY_CONTENT_JSON;

export function createEmptyContentJson(): JSONContent {
  return structuredClone(EMPTY_CONTENT_JSON);
}

/** Alias CLF. */
export const createEmptyBlogContentJson = createEmptyContentJson;
