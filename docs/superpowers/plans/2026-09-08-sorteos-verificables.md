...
- **Espejos de drand:** `https://drand.cloudflare.com`, `https://api.drand.sh`, `https://api2.drand.sh`, `https://api3.drand.sh`. Se consultan dos y tienen que devolver lo mismo. Comprobado contra el servicio el 2026-09-08: una tanda futura responde **HTTP 425**, no 404; el espejo de Cloudflare devuelve los campos en otro orden que los de drand.sh (mismo valor); y uno de los espejos no contestó, así que cada pedido lleva un tope de 8 segundos.
